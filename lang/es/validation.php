...
return [
    ...
    'app_user_already_belongs_to_club' => 'El usuario ya está asociado a uno de tus clubes.',
    ...
    'club_ids_not_owned_by_user' => 'Los siguientes clubes no pertenecen al usuario autenticado: :club_ids.',
    ...
    'court_price_rule_duplicate_price_per_day' => 'No se puede repetir el mismo precio (:prices) en el día :day.',
    'court_price_rule_overlap_within_play_time' => 'No podés definir turnos que se superpongan. El turno de :start_time (:duration min) invade el rango del turno de :conflict_start_time (termina a las :conflict_end_time).',
    ...
    'attributes' => [
        ...
        'feature_ids' => 'características',
        'instagram_url' => 'instagram url',
        'latitude' => 'latitud',
        'longitude' => 'longitud',
        'name' => 'nombre',
        'operating_hours_additional_info' => 'información adicional de horarios',
        ...
        'sort_column' => 'columna de orden',
        'sort_direction' => 'dirección de orden',
        'rules' => 'reglas de precios',
        'rules.*' => 'regla de precio',
        'rules.*.day' => 'día',
        'rules.*.items' => 'elementos',
        'rules.*.items.*' => 'elemento',
        'rules.*.items.*.play_time_minutes' => 'duración de juego',
        'rules.*.items.*.prices' => 'precios',
        'rules.*.items.*.prices.*' => 'precio',
        'rules.*.items.*.prices.*.price' => 'precio',
        'rules.*.items.*.prices.*.starts_at' => 'hora de inicio',
        'services' => 'servicios',
        'sport_type_id' => 'tipo de deporte',
    ...
    'custom' => [
        'club_ids.*' => [
            'distinct' => 'El club seleccionado en la posición :position está duplicado.',
            'exists' => 'El club en la posición :position no existe.',
        ],
        'feature_ids.*' => [
            'distinct' => 'La característica seleccionada en la posición :position está duplicada.',
            'exists' => 'La característica en la posición :position no existe.',
            'integer' => 'La característica en la posición :position debe ser un número.',
        ],
        'services.*' => [
            'distinct' => 'El servicio seleccionado en la posición :position está duplicado.',
        ...
        'working_days.*.closing_hour' => [
            'date_format' => 'La hora de cierre en la posición :position debe tener el formato :format.',
        ],
        'working_days.*.opening_hour' => [
            'required' => 'La hora de apertura en la posición :position es obligatoria.',
            'date_format' => 'La hora de apertura en la posición :position debe tener el formato :format.',
        ],
    ],
];
